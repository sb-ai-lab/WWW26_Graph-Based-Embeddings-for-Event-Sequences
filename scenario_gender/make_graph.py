...
from ptls_extension_2024_research.graphs.graph_construction.gender import GenderGraphBuilder, GenderGraphBuildPipeline
...
def parse_args(args=None):
    ...
    # args.__dict__['orig_col_client_id'] = 'customer_id'
    # args.__dict__['col_item_id'] = "mcc_code"
    # args.__dict__['item_map_file_path'] = "data/mcc_code_mapping.csv"
...
if __name__ == '__main__':
    ...
    GenderGraphBuildPipeline().create_graph(df_data, config, logger)
