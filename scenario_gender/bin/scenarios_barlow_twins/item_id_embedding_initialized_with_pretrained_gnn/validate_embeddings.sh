REPORT_FILE_NAME="barlow_twins_gender__gnn_sequential_training.txt"
CONFIG_DIR="conf/embeddings_validation"
CONFIG_NAME="embeddings_validation_barlow_twins_gnn_sequential_training"
...
PYTHONPATH=.. python -m ptls_extension_2024_research.utils.update_validation_config \
    ...
    filter=regex \
    filter.pattern="barlow_twins__item_id_embed_init_with_pretrained_gnn"
