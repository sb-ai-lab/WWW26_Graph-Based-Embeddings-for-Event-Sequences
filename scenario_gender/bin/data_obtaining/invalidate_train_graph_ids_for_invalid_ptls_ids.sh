...
PYTHONPATH=.. python -m ptls_extension_2024_research.utils.invalidate_graph_ids_for_impossible_input_ids \
    --orig_client_id_column "customer_id" \
    --item_id_column "mcc_code" \
    --invalid_train_graph_id 17000 \
    \
    --not_encoded_test_client_ids_path ./data/test_ids.csv \
    --client_id_map_path ./data/client_id_map.parquet \
    --train_dataset_path ./data/train_trx.parquet \
