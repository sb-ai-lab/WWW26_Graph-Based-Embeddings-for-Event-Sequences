...
PYTHONPATH=.. python -m ptls.pl_train_module \
    ...
    model_path="models/scenario_coles_gnn_0_5__mlp__has_orig_emb_weights.p" \
    logger_name="scenario_coles_gnn_0_5__mlp__has_orig_emb_weights"  \
...
PYTHONPATH=.. python -m pl_inference_with_client_id    \
    model_path="models/scenario_coles_gnn_0_5__mlp__has_orig_emb_weights.p" \
    embed_file_name="scenario_coles_gnn_0_5__mlp__has_orig_emb_weights" \
