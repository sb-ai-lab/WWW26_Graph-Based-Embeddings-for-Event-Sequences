...
sh bin/scenarios_coles_gnn_weighted__contrastive_gnn/w_prediction_BCE_no_orig.sh

echo "==== Scenario: COLEs with Weight Prediction MSE \n\n"
sh bin/scenarios_coles_gnn_weighted__contrastive_gnn/w_prediction_MSE_no_orig.sh
