...
MODEL_NAME="coles_gnn_weighted__w_pred__${GNN_NAME}__mse__no_orig__alpha_${GNN_LOSS_ALPHA}__gamma_${LOSS_GAMMA}__${MAX_EPOCHES}_epoches__contrastive_gnn"
...
PYTHONPATH=.. python -m ptls.pl_train_module \
    ...
    pl_module.include_gnn_users_in_contrastive_loss="true" \
