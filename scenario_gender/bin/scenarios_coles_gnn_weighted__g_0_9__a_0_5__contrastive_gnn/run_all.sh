...
sh bin/scenarios_coles_gnn_weighted__g_0_9__a_0_5__contrastive_gnn/w_prediction_BCE.sh

echo "==== Scenario: COLEs with Weight Prediction MSE \n\n"
sh bin/scenarios_coles_gnn_weighted__g_0_9__a_0_5__contrastive_gnn/w_prediction_MSE.sh
