...
#sh bin/scenarios_coles_gnn_weighted__g_0_9__a_0_5__contrastive_gnn/lp.sh

echo "==== Scenario: COLEs with Weight Prediction BCE \n\n"
sh bin/scenarios_coles_gnn_weighted__g_0_9__a_0_5__contrastive_gnn/w_prediction_BCE_no_orig.sh

echo "==== Scenario: COLEs with Weight Prediction MSE \n\n"
sh bin/scenarios_coles_gnn_weighted__g_0_9__a_0_5__contrastive_gnn/w_prediction_MSE_no_orig.sh
...
python -m embeddings_validation \
    --config-dir conf --config-name embeddings_validation__2024_research_contrastive_gnn +workers=10 +total_cpu_count=4
