REPORT_FILE_NAME="scenario_gender__pretrained_coles_gnn__different_emb_sizes.txt"
CONFIG_DIR="conf/embeddings_validation"
CONFIG_NAME="embeddings_validation__pretrained_coles_gnn__different_emb_sizes"
...
PYTHONPATH=.. python -m ptls_extension_2024_research.utils.update_validation_config \
    ...
    filter=regex \
    filter.pattern="coles_gnn__pretrained_STRING_PATTERN__pretrain_epoches_INT_PATTERN__epoches_INT_PATTERN_embeddings\\.pickle" \
