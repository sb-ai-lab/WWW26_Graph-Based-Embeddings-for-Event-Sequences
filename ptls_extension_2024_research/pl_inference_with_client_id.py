...
from ptls_extension_2024_research.frames.inference_module_client_id_aware.inference_module import InferenceModuleClientIdAware
...
def main(conf: DictConfig):
    ...
    model = InferenceModuleClientIdAware(
        model=seq_encoder,
    ...
    inference_dl = DataLoader(
        ...
        collate_fn=dataset_inference.collate_fn,
        shuffle=False,
        num_workers=conf.inference.get('num_workers', 0),
        batch_size=conf.inference.get('batch_size', 16),
    )
