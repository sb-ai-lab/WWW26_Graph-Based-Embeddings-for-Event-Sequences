...
python -m embeddings_validation \
    --config-dir conf/embeddings_validation --config-name embeddings_validation +workers=8 +total_cpu_count=8 target_name=${target_name} report_file_name=${report_file_name} models/lgbm=${target_name}  # +local_scheduler=false
