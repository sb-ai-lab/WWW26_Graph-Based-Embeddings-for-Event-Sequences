REPORT_FILE_NAME="scenario_gender__barlow_twins_baseline.txt"
CONFIG_DIR="conf/embeddings_validation"
CONFIG_NAME="embeddings_validation_barlow_twins_baseline"
...
PYTHONPATH=.. python -m ptls_extension_2024_research.utils.update_validation_config \
    ...
    filter=regex \
    filter.pattern="barlow_twins_embeddings" # Decided to use "barlow_twins_embeddings.pickle" only
